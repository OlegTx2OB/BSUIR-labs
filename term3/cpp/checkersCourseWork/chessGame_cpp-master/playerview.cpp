...
void PlayerView::setPlayer(isWhite owner)
{
    QString title;
    QString imagePath;
    ...
    // set title
    QGraphicsTextItem *titleItem = Utils::createTextItem(title, 14, Constants::defaultTextColor, this);
    ...
    // set image
    FigureField *pawn = new FigureField({ 0, 0 }, imagePath, this);
