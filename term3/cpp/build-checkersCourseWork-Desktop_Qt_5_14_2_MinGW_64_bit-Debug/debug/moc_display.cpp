...
#include <memory>
#include "../../checkers/checkersCourseWork/display.h"
...
QT_MOC_LITERAL(1, 8, 11), // "getResponse"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8) // "response"

    },
    "Display\0getResponse\0\0response"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getResponse((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
