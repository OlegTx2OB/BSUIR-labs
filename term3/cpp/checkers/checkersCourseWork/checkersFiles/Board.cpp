...
void Board::prepSquares()
{
	for (int i = 0; i < 8; i++)
	{
		...
		for (int j = 0; j < 8; j++)
		{
//666			squares.insert(std::pair <std::pair <int, int>, std::unique_ptr<Square>> (std::make_pair(i, j), std::make_unique<Square>()));
		}
	}
}
...
{
    // White pawns
    setPiece(std::make_pair(6, 0), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 1), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 2), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 3), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 4), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 5), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 6), std::unique_ptr<Pawn>(new Pawn(WHITE)));
    setPiece(std::make_pair(6, 7), std::unique_ptr<Pawn>(new Pawn(WHITE)));

    // Black pawns
    setPiece(std::make_pair(1, 0), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 1), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 2), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 3), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 4), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 5), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 6), std::unique_ptr<Pawn>(new Pawn(BLACK)));
    setPiece(std::make_pair(1, 7), std::unique_ptr<Pawn>(new Pawn(BLACK)));
}
...
{
     //White Rooks
    setPiece(std::make_pair(7, 0), std::unique_ptr<Rook>(new Rook(WHITE)));
    setPiece(std::make_pair(7, 7), std::unique_ptr<Rook>(new Rook(WHITE)));

    // Black Rooks
    setPiece(std::make_pair(0, 0), std::unique_ptr<Rook>(new Rook(BLACK)));
    setPiece(std::make_pair(0, 7), std::unique_ptr<Rook>(new Rook(BLACK)));
}
...
{
	// White Knights
    setPiece(std::make_pair(7, 1), std::unique_ptr<Knight>(new Knight(WHITE)));
    setPiece(std::make_pair(7, 6), std::unique_ptr<Knight>(new Knight(WHITE)));

    // Black Knights
    setPiece(std::make_pair(0, 1), std::unique_ptr<Knight>(new Knight(BLACK)));
    setPiece(std::make_pair(0, 6), std::unique_ptr<Knight>(new Knight(BLACK)));
}
...
{
    // White Bishops
    setPiece(std::make_pair(7, 2), std::unique_ptr<Bishop>(new Bishop(WHITE)));
    setPiece(std::make_pair(7, 5), std::unique_ptr<Bishop>(new Bishop(WHITE)));

    // Black Bishops
    setPiece(std::make_pair(0, 2), std::unique_ptr<Bishop>(new Bishop(BLACK)));
    setPiece(std::make_pair(0, 5), std::unique_ptr<Bishop>(new Bishop(BLACK)));
}
...
{
//	// White Queen
    setPiece(std::make_pair(7, 3), std::unique_ptr<Queen>(new Queen(WHITE)));

    // Black Queen
    setPiece(std::make_pair(0, 3), std::unique_ptr<Queen>(new Queen(BLACK)));
}
...
{
	// White King
    setPiece(std::make_pair(7, 4), std::unique_ptr<King>(new King(WHITE)));

    // Black King
    setPiece(std::make_pair(0, 4), std::unique_ptr<King>(new King(BLACK)));
}
